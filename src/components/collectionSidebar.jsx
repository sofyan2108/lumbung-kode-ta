...
export default function CollectionSidebar({ onSelectCollection, currentUserId }) {
  const { 
    collections, 
    fetchCollections, 
    activeCollectionId, 
      ...
      <div className="w-64 bg-white dark:bg-pastel-dark-surface border-r border-gray-200 dark:border-pastel-dark-border flex flex-col h-full">
        ...
        <div className="p-4 border-b border-gray-100 dark:border-pastel-dark-border">
          <div className="flex justify-between items-center mb-3">
            ...
            >
              <Plus size={18} className="text-indigo-500 group-hover:scale-110 transition" />
            </button>
          </div>
          ...
          {collections.length === 0 ? (
            ...
            collections.map(collection => (
              <div
                ...
                style={{
                  backgroundColor: activeCollectionId === collection.id 
                    ? collection.color + '20' 
